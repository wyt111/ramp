<template>
  <div id="OPM" class="opm-container">
    <!--    <div-->
    <!--      class="opm-title"-->
    <!--      v-html="$t('mexPayment.tiemOut', ['<span>03:00</span>', 'h'])"-->
    <!--    ></div>-->
    <div class="opm-Payment-amount">
      <div class="title">{{ $t("mexPayment.PleasePay") }}</div>
      <div class="amount"><span>TL </span> {{ payAmount }}</div>
    </div>
    ...
    <div class="opm-content">
      ...
      <div class="line line2">
        ...
        <div class="con">{{ $t("mexPayment.new_title2") }}</div>
      </div>
      <div class="content">
        <div class="line_content">
          <div class="title">{{ $t("mexPayment.CLABEinterbancaria") }}</div>
          <p class="code">
            {{ payOrderInfo.bankCad }}

            <copy-img
              v-clipboard="payOrderInfo.bankCad"
        ...
        <div class="line_content">
          ...
          <p>
            <span class="text">{{ payOrderInfo.bankNam }} </span>
            <copy-img
              v-clipboard="payOrderInfo.bankNam"
              v-clipboard:success="firstCopySuccess"
              v-clipboard:error="firstCopyError"
            />
          </p>
        ...
        <div class="line_content">
          ...
          <p>
            <span class="text">{{ payOrderInfo.actNam }} </span>
            <copy-img
              v-clipboard="payOrderInfo.actNam"
              v-clipboard:success="firstCopySuccess"
              v-clipboard:error="firstCopyError"
            />
          </p>
        ...
        <div class="line_content">
          ...
          <p>
            <span class="text">TL {{ payAmount }}</span>
            <copy-img
              v-clipboard="' TL ' + placeOrderQuery.amount"
              v-clipboard:success="firstCopySuccess"
              v-clipboard:error="firstCopyError"
            />
          </p>
      ...
      <div class="content_reference_number">
        ...
        <div class="number-info">
          <span class="text">{{ payOrderInfo.note }}</span>
          <copy-img
            v-clipboard="payOrderInfo.note"
            v-clipboard:success="firstCopySuccess"
            v-clipboard:error="firstCopyError"
          />
        </div>
