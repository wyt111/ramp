...
//公共方法
import { numberHandle, mathJs } from "@/utils/index.js";
...
//ui类库、公共组件
import "./utils/Ui-library/element-ui.js";
import "./utils/Ui-library/vant-ui.js";

//detadog监控
import { detadogMonitor } from "@/utils/publicRequest.js";
detadogMonitor();

//阿里云接口埋点
import "@/utils/aliyunBurialPoint.js";

import VConsole from "vconsole";
if (
  !["sbx", "production"].includes(process.env.VUE_APP_TITLE) &&
  process.env.NODE_ENV !== "local"
) {
  new VConsole();
}

// 线上比较缓存版本号刷新页面清除缓存-需要在package.json修改版本号以及app.vue里修改版本号
  ...
  (function () {
    ...
    if (typeof ic === "function") {
      ...
      var l = function () {
        ...
        s.async = true;
        s.src = "https://widget.intercom.io/widget/grirhrav";
      ...
      F = function (t) {
        var n = function (t) {
          ...
          e =
            ...
            "_" +
            n(y);
        _.write(p, e, 1825, !0), b(e), (window.ftr__gt = e);
      },
      I = function () {
        var t = _.read(p) || "",
          n = t.split("_"),
        ...
        return (
          ...
          (function (t) {
            var n = 40,
              e = "";
            return (
              t.length < n / 2 && (e = "," + r(n / 2 - t.length - 1)),
              o(i(t + e))
            );
          })(c.join(","))
        );
        ...
        try {
          ...
          (window.ftr__fdad = function (n, e) {
            if (!m) {
              ...
              var r = {};
              (r[k] = d(
                window.ftr__config.s,
                siteId,
                window.ftr__config.m.csp
              )),
                u(
                  x,
                  function (e) {
...
//登陆风险账号弹框全局方法
Vue.prototype.isKycLoginToast = function (vm) {
  router.push("/accountsDisabled");
  // vm.tipsState = true;
  // vm.BuyTimeOut = 'login';
};
